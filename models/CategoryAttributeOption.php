...
/**
 * This is the model class for table "category_attribute_options".
 *
 * @property int $id
 ...
 */
class CategoryAttributeOption extends \yii\db\ActiveRecord
{
    ...
    {
        return 'category_attribute_options';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['attribute_id', 'category_id','sort_order'], 'integer'],
